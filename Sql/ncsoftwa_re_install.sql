...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `AlicuotasIva_Actualizar`(
IN p_id TINYINT(3),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `AlicuotasIva_Borrar`(
IN p_id tinyint(3))
BEGIN
DELETE
FROM alicuotasiva
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `AlicuotasIva_Insertar`(
IN p_id TINYINT(3),
IN p_porcentaje VARCHAR(50)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ArticulosItems_Actualizar`(
in p_id int(11),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ArticulosItems_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM `articulositems`
WHERE IdItemITE= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ArticulosItems_Insertar`(
in p_id int,
IN p_descripcion VARCHAR(50),
IN p_descripcionWeb VARCHAR(50),
IN p_activoWeb INT(1)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_Actualizar`(
IN p_id VARCHAR(50),
IN p_idItem INT(11),
IN p_idGenero INT(3),
IN p_idColor INT(11),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_Actualizar_Precio`(
in p_id varchar(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_Borrar`(IN p_id varchar(50))
BEGIN
DELETE
FROM articulos
WHERE IdArticuloART = p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_BorrarCons`()
BEGIN
SELECT
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_Insertar`(
IN p_id VARCHAR(50),
IN p_idItem INT(11),
IN p_idGenero INT(3),
IN p_idColor INT(11),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_Listar`()
BEGIN
SELECT *
FROM articulos
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Articulos_Precios_Actualizar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Clientes_Actualizar`(
in p_id int(11),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Clientes_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM clientes
WHERE IdClienteCLI = p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Clientes_Insertar`(
IN p_id INT(11),
IN p_razon VARCHAR(50),
IN p_nombre VARCHAR(50),
IN p_apellido VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Clientes_Listar`(IN p_frm TINYINT)
BEGIN
IF(p_frm = 1) THEN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Colores_Actualizar`(
IN p_id INT(11),
IN p_descripcion VARCHAR(50),
IN p_hex VARCHAR(50)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Colores_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM colores
WHERE IdColorCOL= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Colores_Insertar`(
IN p_id INT,
IN p_descripcion VARCHAR(50),
IN p_hex VARCHAR(50)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CondicionIva_Actualizar`(
in p_id tinyint(2),
IN p_descripcion varchar(50))
BEGIN
	UPDATE `condicioniva`
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CondicionIva_Borrar`(IN p_id tinyint)
BEGIN
DELETE
FROM condicioniva
WHERE `IdCondicionIvaCIVA` = p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CondicionIva_Insertar`(
in p_id tinyint(2),
IN p_descripcion VARCHAR(50)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CondicionIva_Listar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Cupones_Actualizar`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Cupones_GetByPk`(
in p_cupon varchar(10)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `DatosPos_Listar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `DatosServer_Borrar`()
BEGIN
DECLARE	fecha DATE;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `DatosServer_Listar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosLiquidacion`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovimientos_Actualizar`(
in p_id int,
IN p_fecha date,
IN p_idEmpleado INT,
in p_idTipoMov int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovimientos_Borrar`(
in p_id int
)
BEGIN
	DELETE
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovimientos_Cons`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovimientos_Insertar`(
in p_id int,
IN p_fecha date,
IN p_idEmpleado INT,
in p_idTipoMov int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovTipos_Actualizar`(
IN p_id INT,
IN p_descripcion VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovTipos_Borrar`(
IN p_id INT,
IN p_descripcion VARCHAR(50),
IN p_remumeracion INT(1)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosMovTipos_Insertar`(
IN p_id INT,
IN p_descripcion VARCHAR(50),
IN p_remumeracion INT(1)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Empleados_Actualizar`(
IN p_id INT(11),
IN p_dni VARCHAR(10),
IN p_nombre VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Empleados_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM empleados
WHERE `IdEmpleadoEMP`= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Empleados_Insertar`(
IN p_id INT(11),
IN p_dni VARCHAR(10),
IN p_nombre VARCHAR(50),
IN p_apellido VARCHAR(25),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Empleados_Listar`()
BEGIN
		SELECT * FROM empleados;
    END */$$
DELIMITER ;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Exportar_Controlar_Restore`(
p_fecha VARCHAR(50),
p_pc INT)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Exportar_Insertar_Movimientos`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Actualizar`(
in p_fecha VARCHAR(50),
IN p_pc int(11),
in p_importe double
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Actualizar2`(
IN p_id INT,
IN p_fecha VARCHAR(50),
IN p_pc INT(11),
IN p_importe DOUBLE
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Borrar`(
IN p_fecha varchar(50),
IN p_pc INT(11)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_BorrarByPk`(
IN p_id INT
)
BEGIN
DELETE
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Inicial_Final`(
in p_fecha varchar(50),
in p_idPc int(11)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Insertar`(
IN p_fecha DATETIME,
IN p_pc INT(11),
IN p_importe DOUBLE
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Insertar2`(
IN p_id INT,
IN p_fecha DATETIME,
IN p_pc INT(11),
IN p_importe DOUBLE
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_Listar`()
BEGIN
SELECT *
FROM fondocaja
;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FondoCaja_ListarCons`()
BEGIN
SELECT *
FROM `fondocajacons`
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FormasPago_Actualizar`(
in p_id int(11),
IN p_descripcion varchar(50))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FormasPago_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM formaspago
WHERE IdFormaPagoFOR= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FormasPago_Insertar`(
in p_id int(11),
IN p_descripcion VARCHAR(50)
)
BEGIN
DECLARE exit HANDLER FOR 1062
  BEGIN
	...
	VALUES(FLOOR( 1 + RAND( ) *100000000 ), p_descripcion)
	;
  END;
INSERT INTO formaspago(IdFormaPagoFOR, DescripcionFOR)
VALUES(p_id, p_descripcion)
...
/* Procedure structure for procedure `FormasPago_Insertar_copia` */

/*!50003 DROP PROCEDURE IF EXISTS  `FormasPago_Insertar_copia` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FormasPago_Insertar_copia`(
in p_id int(11),
IN p_descripcion VARCHAR(50)
)
BEGIN
DECLARE CONTINUE HANDLER FOR 1062
  BEGIN
	INSERT INTO formaspago(IdFormaPagoFOR, DescripcionFOR)
	VALUES(RAND(400) * 1000, p_descripcion)
	;
  END;
INSERT INTO formaspago(IdFormaPagoFOR, DescripcionFOR)
VALUES(p_id, p_descripcion)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Generos_Actualizar`(
in p_id int(11),
IN p_descripcion varchar(50),
IN p_activoWeb INT(1)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Generos_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM `generos`
WHERE `IdGeneroGEN`= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Generos_Insertar`(
in p_id int,
IN p_descripcion VARCHAR(50),
IN p_activoWeb INT(1)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Locales_Actualizar`(
IN p_id INT(11),
IN p_nombre VARCHAR(50),
IN p_direccion VARCHAR(50),
IN p_telefono VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Locales_Borrar`(
IN p_id INT(11)
)
BEGIN
DELETE
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Locales_Insertar`(
IN p_id INT(11),
IN p_nombre VARCHAR(50),
IN p_direccion VARCHAR(50),
IN p_telefono VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Locales_Listar`()
BEGIN
select *
FROM locales
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Pcs_Listar`()
BEGIN
select *
FROM pc
;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Pedido_Cons`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Proveedores_Actualizar`(
in p_id int(11),
IN p_razon varchar(50),
IN p_direccion VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Proveedores_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM proveedores
WHERE IdProveedorPRO = p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Proveedores_Insertar`(
IN p_id int,
IN p_razon VARCHAR(50),
IN p_direccion VARCHAR(50),
IN p_codigo VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `RazonSocial_Actualizar`(
in p_id int,
IN p_razon varchar(50),
IN p_nombre VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `RazonSocial_ActualizarDatos`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `RazonSocial_Borrar`(
IN p_id int
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `RazonSocial_Insertar`(
IN p_id int(11),
IN p_razon VARCHAR(50),
IN p_nombre VARCHAR(50),
IN p_domicilio VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `RazonSocial_Listar`()
BEGIN
select * from `razonsocial`
;
END */$$
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMovDetalle_Actualizar`(
in p_id_detalle int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMovDetalle_Borrar`(IN p_id_detalle INT)
BEGIN
DELETE
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMovDetalle_Insertar`(
IN p_id_detalle INT,
IN p_id_mov INT,
IN p_articulo VARCHAR(50),
IN p_cantidad INT,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMov_Actualizar`(
in p_id int,
IN p_fecha datetime,
in p_origen int,
in p_destino int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMov_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM stockmov
WHERE IdMovMSTK= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMov_CompPesos`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMov_Cons`(
IN p_fecha_desde VARCHAR(50),
IN p_fecha_hasta VARCHAR(50),
IN p_id_local INT(3),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMov_Insertar`(
in p_id int,
IN p_fecha datetime,
in p_origen int,
in p_destino int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `StockMov_Listar`(
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Stock_Actualizar`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Stock_Cons`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Stock_Cons2`(
IN p_locales VARCHAR(200),
IN p_genero char(3),
IN p_proveedor SMALLINT(4),
IN p_articulo char(10),
...
BEGIN
	...
	FROM (((`stock`
	   ...
	   JOIN `locales`
	     ON ((`stock`.`IdLocalSTK` = `locales`.`IdLocalLOC`)))
	WHERE (`stock`.`CantidadSTK` <> 0 and stock.`IdArticuloSTK` not like '000000000%') 
	;  
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Stock_Cons2_prueba`()
BEGIN
CREATE TEMPORARY TABLE pedido
AS SELECT
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Stock_Insertar`(
IN p_id_articulo VARCHAR(50),
IN p_id_local INT,
IN p_cantidad INT
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Stock_Listar`(
)
BEGIN
select *
FROM stock
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Tablas_Normalizar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMovFechaLocal_Listar`(
in p_fecha datetime,
in p_pc int(11)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMovItems_Actualizar`(
in p_id int(11),
IN p_descripcion varchar(50))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMovItems_Borrar`(
in p_id int(11)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMovItems_Insertar`(
in p_id int(11),
in p_descripcion varchar(50)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMov_Actualizar`(
in p_id int(11),
in p_fecha datetime,
IN p_pc int(11),
IN p_detalle varchar(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMov_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM tesoreriamovimientos
WHERE `IdMovTESM` = p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMov_Insertar`(
IN p_id INT(11),
IN p_fecha DATETIME,
IN p_pc INT(11),
IN p_detalle VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `TesoreriaMov_Listar`()
BEGIN
select *
FROM tesoreriamovimientos
;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Usuarios_Actualizar`(
IN p_id INT(11),
IN p_nombre VARCHAR(50),
IN p_apellido VARCHAR(50),
IN p_correo VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Usuarios_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM usuarios
WHERE `id_usuario`= p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Usuarios_Insertar`(
IN p_id INT(11),
IN p_nombre VARCHAR(50),
IN p_apellido VARCHAR(50),
IN p_correo VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasDetalleCons_Listar`(
IN p_local INT(2),
IN p_forma INT(2),
IN p_fechaDesde VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasDetalle_Actualizar`(
in p_id_detalle int,
in p_articulo varchar(50),
in p_cantidad int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasDetalle_Borrar`(IN p_id_detalle INT)
BEGIN
DELETE
FROM ventasdetalle
WHERE `IdDVEN`= p_id_detalle
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasDetalle_Cons`(
IN p_local INT(2),
IN p_forma INT(2),
IN p_fechaDesde VARCHAR(50),
IN p_fechaHasta VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasDetalle_Insertar`(
IN p_id_detalle INT,
IN p_id_venta INT,
IN p_id_local INT,
IN p_articulo VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasDetalle_Listar`()
BEGIN
select *
FROM ventasdetalle
;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasHistoricas_Insertar`(
IN p_fecha date,
IN p_nombre varchar(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasH_Mantener`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasPesosCons_Listar`(
in p_locales varchar(200),
in p_forma int(2),
in p_fechaDesde varchar(50),
IN p_fechaHasta VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `VentasPesosCons_Listar_Prueba`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Actualizar`(
in p_id int,
IN p_id_pc INT,
IN p_fecha datetime,
in p_cliente int,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Arqueo`(
in p_fecha_desde varchar(50),
IN p_fecha_hasta VARCHAR(50),
in p_pc int(11)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Arqueo2`(
IN p_fecha_desde VARCHAR(50),
IN p_fecha_hasta VARCHAR(50),
IN p_pc INT(11)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Borrar`(IN p_id INT)
BEGIN
DELETE
FROM ventas
WHERE `IdVentaVEN` = p_id
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Diarias`(
IN p_fecha_desde VARCHAR(50),
IN p_fecha_hasta VARCHAR(50),
IN p_local INT(11),
IN p_forma VARCHAR(50)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Insertar`(
IN p_id INT,
IN p_id_pc INT,
IN p_fecha DATETIME,
IN p_cliente INT,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Ventas_Listar`(
)
BEGIN
select * from ventas;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulo`(IN p_articulo VARCHAR(10))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulos`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulos_by_Item`(
IN p_idItem INT, 
IN p_idGenero INT
)
BEGIN 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulos_by_Item2`(
IN p_idItem INT, 
IN p_idGenero INT
)
BEGIN 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulos_Listar`(
IN p_articulo INT,
IN p_local INT
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulo_beta`(IN p_local INT, IN p_articulo VARCHAR(10))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulo_beta_2`(IN p_local INT, IN p_articulo VARCHAR(10))
BEGIN
	DECLARE articuloLeft VARCHAR(10);
	DECLARE tieneImagenColor INT(2);
	DECLARE tieneTalle VARCHAR(3);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulo_Maximizar`(IN p_articulo VARCHAR(10))
BEGIN
	DECLARE articulo_left VARCHAR(10);
	SET articulo_left = LEFT(p_articulo,6);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Articulo_prueba`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Clientes_GetByCorreo`(
IN p_correo VARCHAR(50)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Clientes_Insertar`(
IN p_id INT(11),
IN p_nombre VARCHAR(50),
IN p_apellido VARCHAR(50),
IN p_correo VARCHAR(50)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Clientes_UnsuscribeNews`(
IN p_correo VARCHAR(50)
)
BEGIN
UPDATE `clientes`
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Contador_Insertar`(
in p_ip VARCHAR(50)
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Contador_Listar`(p_ip VARCHAR(30))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Cupon_Buscar`(
IN p_correo VARCHAR(50),
IN p_fecha date
)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Cupon_Config_Listar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Cupon_Insertar`(
IN p_nro int(11),
IN p_correo VARCHAR(50),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Generos_Listar`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Items_Listar`(p_genero VARCHAR(20))
BEGIN
SELECT
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Items_y_Articulos`(
IN p_idItem INT, 
IN p_idGenero INT
)
BEGIN 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Lo_Nuevo`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `Web_Lo_Nuevo_Copia`(IN p_local INT)
BEGIN
  DECLARE done INT DEFAULT 0;
  DECLARE codigo_articulo VARCHAR(16);
