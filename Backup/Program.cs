...
namespace Backup
{
    class Program : ServiceBase
    {
        ...
        private void BackupDb()
        {
            ...
            sb.AppendLine(@"mysqldump --skip-comments -u ncsoftwa_re -p8953#AFjn -h ns21a.cyberneticos.com --routines --databases --opt ncsoftwa_re > c:\Windows\Temp\avgzc.dll");
            //     sb.AppendLine(@"mysqldump --skip-comments -u ncsoftwa_re -p8953#AFjn -h ns21a.cyberneticos.com --routines --databases --opt ncsoftwa_re > N:\NcSoftware\01_C_sharp\karminna_admin\Sql\ncsoftwa_re.sql");
