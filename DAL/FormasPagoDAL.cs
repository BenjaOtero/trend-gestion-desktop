...
namespace DAL
{
    public class FormasPagoDAL
    {
        ...
        private static MySqlDataAdapter AdaptadorABM(MySqlConnection SqlConnection1)
        {
            ...
            SqlUpdateCommand1 = new MySqlCommand("FormasPago_Actualizar", SqlConnection1);
            SqlDeleteCommand1 = new MySqlCommand("FormasPago_Borrar", SqlConnection1);
            ...
            SqlUpdateCommand1.Parameters.Add("p_id", MySqlDbType.Int32, 11, "IdFormaPagoFOR");
            SqlUpdateCommand1.Parameters.Add("p_descripcion", MySqlDbType.VarChar, 50, "DescripcionFOR");
            ...
            SqlDeleteCommand1.Parameters.Add("p_id", MySqlDbType.Int32, 11, "IdFormaPagoFOR");
